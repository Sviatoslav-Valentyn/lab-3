    ...
    public void addGood(final Good good, final int amount) {
        ...
        for (Map.Entry<Good, Integer> entry : goods.entrySet()) {
            if (entry.getKey().equals(good.getName()) && entry.getKey().
                    getManufacturer().equals(good.getManufacturer()) && entry.getKey().
        ...
        final Good tmp = new Good(good.getManufacturer(), good.getName(),
        ...
        for (Map.Entry<Good, Integer> deliveredEntry : deliveredGoods.entrySet()) {
            ...
            for (Map.Entry<Good, Integer> availableEntry : goods.entrySet()) {
                if (availableEntry.getKey().getName().equals(deliveredEntry.getKey().
                        getName()) && availableEntry.getKey().getManufacturer().
                        equals(deliveredEntry.getKey().getManufacturer()) && availableEntry.
            ...
            if (!available) {
                final  Good tmp = new Good(deliveredEntry.getKey().getManufacturer(),
    ...
    public void sellGood(final Good good, int amount) {
        for (Map.Entry<Good, Integer> entry : goods.entrySet()) {
            if (entry.getKey().getName().equals(good.getName()) && entry.getKey().
                    getManufacturer().equals(good.getManufacturer())) {
